...
class JiraWrapper
  ...
  def initialize
    @client = JIRA::Client.new(username: 'jira-api', password: ENV['JIRA_PASSWORD'], context_path: '', site: 'https://near-me.atlassian.net', rest_base_path: '/rest/api/2', auth_type: :basic, read_timeout: 120)
  end
