  ...
  class VolteSetup
    ...
    def create_waiver_agreements!
      @instance.waiver_agreement_templates.where(name: "Bond Value Terms").first_or_create!(
        content: "<p> Lenders may choose to include bonds in their Listings (“Security Deposits”). Each Listing will describe whether a bond is required for the applicable Item. Lenders acknowledge that no authorisation is made over the relevant Borrower’s card and no charges are taken from the relevant Borrower. </p> <p> The Borrower agrees that s/he is responsible to compensate the Lender should the item be damaged or lost and will charged for any amounts deemed payable by The Volte if a dispute is raised. </p> <p> For more information on Bonds please see the <a href='/terms-of-service'>Terms of Service</a>. </p>")
    end
    ...
    def create_custom_attributes!
      ...
      create_custom_attribute(@transactable_type, {
        ...
        required: "0",
        public: true,
        aggregate_in_search: true,
        valid_values: ['Dress', 'Bag', 'Millinery', 'Menswear', 'Accessories'],
        searchable: true,
      ...
      create_custom_attribute(@transactable_type, {
        ...
        searchable: true,
        wrapper_html_options: { 'data-visibility-dependent' => 'menswear' }
      })
    ...
    def create_or_update_form_components!
      ...
      component.form_fields = [
        ...
        { 'transactable' => 'item_style_menswear' },
        { 'transactable' => 'dress_size' },
        { 'transactable' => 'milinery_size' },
        { 'transactable' => 'menswear_size' },
