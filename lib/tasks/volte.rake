...
namespace :volte do
  ...
  class VolteSetup
    ...
    def create_custom_attributes!
      ...
      create_custom_attribute(@transactable_type,         name: 'item_type',
                                                          label: 'Item Type',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
                                                          public: true,
                                                          valid_values: %w(Dress Bag Milinery Outerwear Accessories),
                                                          searchable: true,
                                                          input_html_options: { 'data-show-field' => 'value-dependent' })

      create_custom_attribute(@transactable_type,         name: 'item_style_bag',
                                                          label: 'Item Style',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'item_style_milinery',
                                                          label: 'Item Style',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
                                                          public: true,
                                                          valid_values: %w(Fascinator Hat),
                                                          searchable: true,
                                                          wrapper_html_options: { 'data-visibility-dependent' => 'milinery' })

      create_custom_attribute(@transactable_type,         name: 'item_style_outerwear',
                                                          label: 'Item Style',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
                                                          public: true,
                                                          valid_values: %w(Blazer Coat Denim Leather Fur),
                                                          searchable: true,
                                                          wrapper_html_options: { 'data-visibility-dependent' => 'outerwear' })

      create_custom_attribute(@transactable_type,         name: 'item_style_dress',
                                                          label: 'Item Style',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'item_style_accessories',
                                                          label: 'Item Subtype',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
                                                          public: true,
                                                          valid_values: %w(Necklace Belt Other),
                                                          searchable: true,
                                                          wrapper_html_options: { 'data-visibility-dependent' => 'accessories' })

      create_custom_attribute(@transactable_type,         name: 'dress_size',
                                                          label: 'Dress Size',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'milinery_size',
                                                          label: 'Milinery Size',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'outerwear_size',
      ...
      create_custom_attribute(@transactable_type,         name: 'dress_length',
                                                          label: 'Dress Length',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'color',
                                                          label: 'Color',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'designer_name',
                                                          label: 'Item Designer',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'retail_value',
                                                          label: 'Retail Value',
                                                          attribute_type: 'string',
                                                          html_tag: 'input',
                                                          required: '0',
      ...
      create_custom_attribute(@transactable_type,         name: 'bond_value',
                                                          label: 'Bond Value',
      ...
      create_custom_attribute(@transactable_type,         name: 'dry_cleaning',
                                                          label: 'Dry Cleaning',
                                                          attribute_type: 'string',
                                                          html_tag: 'select',
                                                          required: '0',
