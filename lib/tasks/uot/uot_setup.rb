class UotSetup
  def initialize(instance, default_profile_type=nil, instance_profile_type=nil)
    @instance = instance
    @default_profile_type = @instance.default_profile_type || InstanceProfileType.find(569)
    @instance_profile_type = @instance.buyer_profile_type || InstanceProfileType.find(571)
    @lister_instance_profile_type = @instance.seller_profile_type || InstanceProfileType.find(570)
  end
  ...
  def create_custom_attributes!
    ...
    cv.required = Rails.env.test? ? '0' : '1'
  ...
  def create_langauge_categories
    ...
    root_category.mandatory = !Rails.env.test?
