namespace :documentation do
  ...
  task :frontend_docs do
    ...
    system("export RUBY_THREAD_VM_STACK_SIZE=5000000; bundle exec yard -e lib/yard_frontend_customizations.rb -p .yard/frontend_template/ --hide-tag todo --markup markdown 'lib/liquid/**/*.rb' 'app/liquid_tags/*.rb' 'app/forms/**/*.rb'")
  ...
  task :check_frontend_docs_coverage do
    ...
    system("yard stats -e lib/yard_stats_customizations.rb --list-undoc --plugin yard-activerecord 'lib/liquid/**/*.rb' 'app/liquid_tags/*.rb'")
