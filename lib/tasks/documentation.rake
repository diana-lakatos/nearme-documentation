namespace :documentation do
  ...
  task :frontend_docs do
    ...
    system("export RUBY_THREAD_VM_STACK_SIZE=5000000; yard -e lib/yard_frontend_customizations.rb -p .yard/frontend_template/ --hide-tag todo --plugin yard-activerecord --markup markdown 'app/**/*.rb' 'lib/liquid_filters.rb' 'db/schema.rb'")
