namespace :documentation do
  ...
  task :frontend_docs do
    ...
    system("export RUBY_THREAD_VM_STACK_SIZE=5000000; yard -e lib/yard_omits_frontend.rb -p .yard/frontend_template/ --hide-tag todo --plugin yard-activerecord --markup markdown 'app/**/*.rb' 'db/schema.rb'")
