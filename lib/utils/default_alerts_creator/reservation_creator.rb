class Utils::DefaultAlertsCreator::ReservationCreator < Utils::DefaultAlertsCreator::WorkflowCreator
  ...
  def request_rating_of_guest_from_host_email!
    create_alert!({associated_class: WorkflowStep::ReservationWorkflow::GuestRatingRequested, name: 'request_rating_of_guest_from_host', path: 'rating_mailer/request_rating_of_guest_from_host', subject: "How was your experience hosting {{@reservation.owner.first_name}}?", alert_type: 'email', recipient_type: 'lister'})
  end

  def request_rating_of_host_from_guest_email!
    create_alert!({associated_class: WorkflowStep::ReservationWorkflow::HostRatingRequested, name: 'request_rating_of_host_from_guest', path: 'rating_mailer/request_rating_of_host_and_product_from_guest', subject: "How was your experience at '{{reservation.listing.name}}'?", alert_type: 'email', recipient_type: 'enquirer'})
  end
