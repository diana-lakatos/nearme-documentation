...
current_path = '/data/desksnearme/current'
shared_path = '/data/desksnearme/shared'
shared_bundler_gems_path = "/data/desksnearme/shared/bundled_gems"
working_directory '/data/desksnearme/current/'
...
listen '/var/run/engineyard/unicorn_desksnearme.sock', :backlog => 1024
...
pid "/var/run/engineyard/unicorn_desksnearme.pid"
...
after_fork do |server, worker|
  worker_pid = File.join(File.dirname(server.config[:pid]), "unicorn_worker_desksnearme_#{worker.nr}.pid")
