Raygun.setup do |config|
  ...
  config.ignore << ['Transactable::NotFound', 'Listing::NotFound', 'Location::NotFound', 'Page::NotFound', 'Reservation::NotFound', 'RecurringBooking::NotFound', 'MarketplaceErrorLogger::Error']
end
