...
class NewSignupFormForSpacer < ActiveRecord::Migration
  def up
    ...
    if instance.present?
      ...
      instance.theme.pages.where(slug: 'new-signup').first_or_create!(path: 'new-signup').update_attributes(content: %(
...
{% render_form new_lister_signup_form, object_class: User, object_id: 'new' %}
                                                                       ))
      ...
      fc = FormConfiguration.where(name: 'new_lister_signup_form', base_form: 'UserSignup::ListerUserSignup').first_or_create!.update_attributes(
        configuration: {
          name: {
            validation: {
              'presence' => {}
...
<section class="multistep-signup" data-multistep-signup>
  {% if current_user == blank %}
    ...
    {% assign subscription_booking_prefix = transactable_prefix | append: '[subscription_booking_attributes]' %}
    {% assign pricing_prefix = subscription_booking_prefix | append: '[pricings_attributes][0]' %}

    {% form_for form, url: '/api/users.html', as: user, method: 'post', html-class: 'no_inheritance', html-multipart: 'true' %}
      {% if form.errors %}
        <ul>
      ...
      {% endif %}
      <input value="{{ form_configuration.id }}" type="hidden" name="form_configuration_id" data-form-configuration-field>
      <input value="{{ @page.id }}" type="hidden" name="page_id" data-form-configuration-field>
      <input value="/dashboard" type="hidden" name="return_to" data-form-configuration-field>
      <input type="hidden" name="form[profiles_attributes][0][seller_attributes][enabled]" value="1" data-form-configuration-field>
      <div class="step active-step" data-step="0">
        ...
        <fieldset data-form-field="required-group">
          ...
          <ul class="radio-list">
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4598" id="transactable-space-type-garage" required {% if form.companies.first.locations.first.transactables['space'].first.categories[''] == '4598' %}checked=checked{% endif %} data-space-type="grg">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="6521" id="transactable-space-type-parking-space" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '6521' %}checked=checked{% endif %} data-space-type="prksp">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4604" id="transactable-space-type-yard" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4604' %}checked=checked{% endif %} data-space-type="yrd">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4599" id="transactable-space-type-shed" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4599' %}checked=checked{% endif %} data-space-type="shd">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4600" id="transactable-space-type-bedroom" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4600' %}checked=checked{% endif %} data-space-type="bdr">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="5617" id="transactable-space-type-storage-cage" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '5617' %}checked=checked{% endif %} data-space-type="strcage">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4602" id="transactable-space-type-basement" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4602' %}checked=checked{% endif %} data-space-type="bsm">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4603" id="transactable-space-type-attic" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4603' %}checked=checked{% endif %} data-space-type="att">
            ...
            <li>
              <input type="radio" name="{{ storage_category_prefix }}" value="4756" id="transactable-space-type-other" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Storage Type'] == '4756' %}checked=checked{% endif %} data-space-type="oth">
        ...
        <fieldset data-form-field="required-group">
          ...
          <ul class="radio-list double">
            <li>
              <input type="radio" name="{{ access_category_prefix }}" id="transactable-access-type-fulltime" value="3389" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Access'] == '3389' %}checked=checked{% endif %} data-access-type="full" data-access-type-modifier="0">
            ...
            <li>
              <input type="radio" name="{{ access_category_prefix }}" id="transactable-access-type-partial" value="3390" required {% if form.companies.first.locations.first.transactables['space'].first.categories['Access'] == '3390' %}checked=checked{% endif %} data-access-type="partial" data-access-type-modifier="-50">
      ...
      <div class="step" data-step="1">
        ...
        <fieldset data-form-field="required-group">
          ...
          <ul class="checkbox-list">
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-alarm" value="4750" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '4750' %}checked=checked{% endif %} data-security>
            ...
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-cctv" value="4751" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '4751' %}checked=checked{% endif %} data-security>
            ...
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-deadlock" value="4752" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '4752' %}checked=checked{% endif %} data-security>
            ...
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-security-bars" value="5960" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '5960' %}checked=checked{% endif %} data-security>
            ...
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-combination-lock" value="4753" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '4753' %}checked=checked{% endif %} data-security>
            ...
            <li>
              <input type="checkbox" name="{{ security_category_prefix }}" id="transactable-security-roller-door" value="4754" data-required-group="security" {% if form.companies.first.locations.first.transactables['space'].first.categories['Security Features'] contains '4754' %}checked=checked{% endif %} data-security>
        ...
        <fieldset data-form-field="dimensions">
          ...
          <input type='hidden' name='{{ properties_prefix }}[size_of_space]' value="{{ form.companies.first.locations.first.transactables['space'].first.properties.size_of_space }}" data-dimensions-field>

          <ul class="multistep-signup-dimensions">
            <li>
              <label for="transactable-dimensions-width">Width</label>
              <span class="field-addon">
                <input type="number" name="dimensions_width" placeholder="Width" id="transactable-dimensions-width" required min="0" data-dimensions-width value="{{ params['dimensions_width'] }}">
            ...
            <li>
              ...
              <span class="field-addon">
                ...
                <input type="number" placeholder="Length" name="dimensions_length" id="transactable-dimensions-length" required min="0" data-dimensions-length value="{{ params['dimensions_length'] }}">
                <abbr title="Meters" class="field-suffix">m</abbr>
              </span>
            </li>
            <li>
              ...
              <span class="field-addon">
                <span class="field-prefix">&times;</span>
                <input type="number" name="dimensions_height" placeholder="Height" id="transactable-dimensions-height" required min="0" data-dimensions-height value="{{ params['dimensions_height'] }}">
                <abbr title="Meters" class="field-suffix">m</abbr>
              </span>
            </li>
          </ul>
          ...
          <p class="multistep-signup-surface-capacity">
            ...
            <span class="field-addon">
              <input type="number" placeholder="surface" id="transactable-dimensions-surface" required min="0" data-dimensions-surface readonly name="dimensions_surface" value="{{ params['dimensions_surface'] | default: 0 }}">
            ...
            <span class="field-addon">
              <input type="number" placeholder="capacity" id="transactable-dimensions-capacity" required min="0" data-dimensions-capacity readonly name="dimensions_capacity" value="{{ params['dimensions_capacity'] | default: 0 }}">
        ...
        <fieldset data-form-field="required-group">
          ...
          <ul class="checkbox-list">
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-clothes" value="Clothes" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Clothes' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-caravan" value="Caravan" data-required-group="storage_purpose"  {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Caravan' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-boat" value="Boat" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Boat' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-car" value="Car" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Car' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-furniture" value="Furniture" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Furniture' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-docs" value="Office Docs" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Office Docs' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-trailer" value="Trailer" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Trailer' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-workshop" value="Workshop" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Workshop' %}checked=checked{% endif %} data-storage-purpose>
            ...
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[space_suitability][]" id="transactable-storage-purpose-container" value="Container" data-required-group="storage_purpose" {% if form.companies.first.locations.first.transactables['space'].first.properties.space_suitability contains 'Container' %}checked=checked{% endif %} data-storage-purpose>
        ...
        <fieldset data-form-field="group">
          ...
          <ul class="checkbox-list">
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-water-tight" value="The space is water tight" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'The space is water tight' %}checked=checked{% endif %} data-key-feature>
              <label for="transactable-storage-feature-water-tight">The space is water tight</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-power" value="The space has power" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'The space has power' %}checked=checked{% endif %} data-key-feature>
              <label for="transactable-storage-feature-power">The space has power</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-train" value="Close to Train station" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'Close to Train station' %}checked=checked{% endif %} data-key-feature>
              <label for="transactable-storage-feature-train">Close to Train station</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-uni" value="Close to UNI" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'Close to UNI' %}checked=checked{% endif %} data-key-feature>
              <label for="transactable-storage-feature-uni">Close to UNI</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-hospital" value="Close to hospital" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'Close to hospital' %}checked=checked{% endif %} data-key-feature>
              <label for="transactable-storage-feature-hospital">Close to hospital</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[other_space_details][]" id="transactable-storage-feature-shopping-centre" value="Close to shopping centre" {% if form.companies.first.locations.first.transactables['space'].first.properties.other_space_details contains 'Close to shopping centre' %}checked=checked{% endif %} data-key-feature>
      ...
      <div class="step" data-step="2">
        ...
        <fieldset data-form-field="group">
          ...
          <ul class="checkbox-list double">
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[my_rules][]" id="transactable-storage-rule-storage-only" value="Suitable for storage only" {% if form.companies.first.locations.first.transactables['space'].first.properties.my_rules contains 'Suitable for storage only' %}checked=checked{% endif %} data-space-rule>
              <label for="transactable-storage-rule-storage-only">Suitable for storage only</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[my_rules][]" id="transactable-storage-rule-parking-only" value="Suitable for parking only" {% if form.companies.first.locations.first.transactables['space'].first.properties.my_rules contains 'Suitable for parking only' %}checked=checked{% endif %} data-space-rule>
              <label for="transactable-storage-rule-parking-only">Suitable for parking only</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[my_rules][]" id="transactable-storage-rule-notice" value="Please let me know 24hours before visting the space" {% if form.companies.first.locations.first.transactables['space'].first.properties.my_rules contains 'Please let me know 24hours before visting the space' %}checked=checked{% endif %} data-space-rule>
              <label for="transactable-storage-rule-notice">Let me know 24hrs before visiting</label>
            </li>
            <li>
              <input type="checkbox" name="{{ properties_prefix }}[my_rules][]" id="transactable-storage-rule-infrequent-access" value="Access infrequently only" {% if form.companies.first.locations.first.transactables['space'].first.properties.my_rules contains 'Access infrequently only' %}checked=checked{% endif %} data-space-rule>
        ...
        <div class="form-field" data-form-field>
          ...
          <textarea id="transactable-additional-rules" name="{{ properties_prefix }}[additional_rules]" placeholder="Enter any additional rules you might have regarding your space" rows="4" cols="70" data-space-rule>{{ form.companies.first.locations.first.transactables['space'].first.properties.additional_rules }}</textarea>
        ...
        <fieldset data-form-field="required-group">
          ...
          <ul class="radio-list double">
            <li>
              <input type="radio" name="{{ properties_prefix }}[bond_or_deposit]" value="$50 Deposit" id="transactable-deposit-50" required {% if form.companies.first.locations.first.transactables['space'].first.properties.bond_or_deposit contains '$50 Deposit' %}checked=checked{% endif %} data-deposit> <label for="transactable-deposit-50">$50 Deposit</label>
            </li>
            <li>
              <input type="radio" name="{{ properties_prefix }}[bond_or_deposit]" value="$100 Deposit" id="transactable-deposit-100" required {% if form.companies.first.locations.first.transactables['space'].first.properties.bond_or_deposit contains '$100 Deposit' %}checked=checked{% endif %} data-deposit> <label for="transactable-deposit-100">$100 Deposit</label>
            </li>
            <li>
              <input type="radio" name="{{ properties_prefix }}[bond_or_deposit]" value="$150 Deposit" id="transactable-deposit-150" required {% if form.companies.first.locations.first.transactables['space'].first.properties.bond_or_deposit contains '$150 Deposit' %}checked=checked{% endif %} data-deposit> <label for="transactable-deposit-150">$150 Deposit</label>
            </li>
            <li>
              <input type="radio" name="{{ properties_prefix }}[bond_or_deposit]" value="$200 Deposit" id="transactable-deposit-200" required {% if form.companies.first.locations.first.transactables['space'].first.properties.bond_or_deposit contains '$200 Deposit' %}checked=checked{% endif %} data-deposit> <label for="transactable-deposit-200">$200 Deposit</label>
            </li>
          </ul>
        </fieldset>
      </div><!-- step -->
      ...
      <div class="step" data-step="3">
        ...
        <input type='hidden' name='{{ subscription_booking_prefix }}[transactable_type_action_type_id]' value='777'>
        <input type='hidden' name='{{ subscription_booking_prefix }}[enabled]' value='1'>
        ...
        <div class="form-field space-cost" data-form-field="price">
          ...
          <span class="field-addon">
            <span class="field-prefix">$</span><input type="number" name="{{ pricing_prefix }}[price]" id="transactable-cost" required min="0" value="{{ form.companies.first.locations.first.transactables['space'].first.subscription_booking.first.pricings.first.price }}">
      ...
      <div class="step" data-step="4">
        ...
        <div class="form-field" data-form-field>
          <label for="user-name">Name <abbr title="required field">*</abbr></label>
          <input type="text" name="form[name]" id="user-name" value="{{ form.name }}" required>
        </div>

        <div class="form-field" data-form-field="username">
          <label for="user-email">Email <abbr title="required field">*</abbr></label>
          <input type="email" name="form[email]" id="user-email" value="{{ form.email }}" required>

          <p class="help">Your email will be used to login to our platform.</p>
        </div>

        <div class="form-field" data-form-field="password">
          <label for="user-password">Password<abbr title="required field">*</abbr></label>
          <input type="password" name="form[password]" id="user-password" required pattern=".{6,}">
          <p class="help">Password must be at least 6 characters long</p>
        </div>

        <div class="form-field checkbox" data-form-field="checkbox">
          <input type="checkbox" name="form[accept_terms_of_service]" id="user-tos" value="1" {% if form.accept_terms_of_service == '1' %}checked=checked{% endif %} required>
          <label for="user-tos">
            Confirm that you accept the <a href="/terms-conditions" target="_blank">Terms of Service</a> and <a href="/privacy-policy" target="_blank">Privacy Policy</a>
          </label>
        </div>

      </div><!-- step -->

      <div class="step summary-step" data-step="5">
        <h3>Confirm &amp; Submit your listing</h3>

        <p>Hey <b data-summary-user-name>renter</b>!</p>

        <p>Your space will be listed under <b data-summary-space-name>undefined</b> name. Here's how you describe it:</p>

        <blockquote data-summary-description></blockquote>

        <p>Your space is a(n) <b data-summary-space-type>not provided</b>, located at <b data-summary-location>not provided</b>. It has following dimensions: <b data-summary-dimensions></b>.</p>
        <p>Renters will have <b data-summary-access-type>unknown</b> access to the rented space.</p>
        <p>This space is secured by: <b data-summary-security>unknown</b> and is suitable for storing: <b data-summary-storage-purpose>unknown</b>.</p>
        <p>It has following key features: <b data-summary-key-features>not provided</b>.</p>
        <p><b data-summary-images></b></p>

        <div class="rules" data-summary-rules></div>

        <p>Key/fob deposit will be set to: <b data-summary-deposit>not provided</b>, and you would like to list the space for <b data-summary-price>$0</b></p>

        <p>You will be using following email address to log in to the platform <b data-summary-email>example@example.com</b></p>

        <p>If everything looks good, go ahead and&hellip;</p>
...
EOS
      ...
      p = instance.theme.pages.find_by(slug: 'new-signup')
