...
ActiveRecord::Schema.define(version: 20_161_007_150_808) do
  ...
  add_index 'activity_feed_events', %w(instance_id followed_id followed_type), name: 'activity_feed_events_instance_followed', using: :btree
  ...
  add_index 'activity_feed_subscriptions', %w(follower_id followed_id followed_type), name: 'afs_followers_followed', unique: true, using: :btree
  add_index 'activity_feed_subscriptions', %w(follower_id followed_identifier), name: 'index_subscriptions_on_folllower_and_followed_identifier', unique: true, using: :btree
  add_index 'activity_feed_subscriptions', %w(instance_id followed_id followed_type), name: 'activity_feed_subscriptions_instance_followed', using: :btree
  ...
  add_index 'addresses', %w(instance_id entity_id entity_type address), name: 'index_addresses_on_entity_id_and_entity_type_and_address', unique: true, using: :btree
  ...
  add_index 'amenity_holders', %w(holder_id holder_type), name: 'index_amenity_holders_on_holder_id_and_holder_type', using: :btree
  ...
  add_index 'amenity_types', %w(name instance_id), name: 'index_amenity_types_on_name_and_instance_id', unique: true, using: :btree
  ...
  add_index 'api_keys', %w(instance_id token), name: 'index_api_keys_on_instance_id_and_token', unique: true, using: :btree
  ...
  add_index 'approval_requests', %w(owner_id owner_type), name: 'index_approval_requests_on_owner_id_and_owner_type', using: :btree
  ...
  add_index 'assigned_waiver_agreement_templates', %w(target_id target_type), name: 'awat_target_id_and_target_type', using: :btree
  ...
  add_index 'authentications', %w(instance_id provider user_id), name: 'one_provider_type_per_user_index', unique: true, using: :btree
  add_index 'authentications', %w(instance_id uid provider), name: 'one_active_provider_uid_pair_per_marketplace', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'availability_rules', %w(target_type target_id), name: 'index_availability_rules_on_target_type_and_target_id', using: :btree
  ...
  add_index 'availability_templates', %w(instance_id transactable_type_id), name: 'availability_templates_on_instance_id_and_tt_id', using: :btree
  add_index 'availability_templates', %w(parent_type parent_id), name: 'index_availability_templates_on_parent_type_and_parent_id', using: :btree
  ...
  add_index 'billing_authorizations', %w(reference_id reference_type), name: 'index_billing_authorizations_on_reference_id_and_reference_type', using: :btree
  ...
  add_index 'categories_categorizables', %w(instance_id categorizable_id categorizable_type), name: 'poly_categorizables', using: :btree
  ...
  add_index 'category_linkings', %w(instance_id category_linkable_id category_linkable_type category_id), name: 'index_category_linkings_on_instance_id_linkable_unique', unique: true, using: :btree
  ...
  add_index 'charge_types', %w(charge_type_target_id charge_type_target_type), name: 'act_target', using: :btree
  ...
  add_index 'comments', %w(instance_id commentable_id commentable_type), name: 'index_on_commentable', using: :btree
  ...
  add_index 'community_reporting_aggregates', %w(instance_id start_date end_date), name: 'index_community_reporting_aggregates_on_dates', unique: true, using: :btree
  ...
  add_index 'companies', %w(external_id instance_id), name: 'companies_external_id_uni_idx', unique: true, where: '((external_id IS NOT NULL) AND (deleted_at IS NULL))', using: :btree
  add_index 'companies', %w(instance_id listings_public), name: 'index_companies_on_instance_id_and_listings_public', using: :btree
  ...
  add_index 'company_industries', %w(industry_id company_id), name: 'index_company_industries_on_industry_id_and_company_id', using: :btree
  ...
  add_index 'content_holders', %w(instance_id theme_id name), name: 'index_content_holders_on_instance_id_and_theme_id_and_name', using: :btree
  ...
  add_index 'custom_attributes', %w(instance_id transactable_type_id), name: 'index_tta_on_instance_id_and_transactable_type_id', using: :btree
  add_index 'custom_attributes', %w(name target_id target_type deleted_at), name: 'index_custom_attributes_on_name_and_target_and_type_and_deleted', unique: true, using: :btree
  add_index 'custom_attributes', %w(target_id target_type), name: 'index_custom_attributes_on_target_id_and_target_type', using: :btree
  ...
  add_index 'custom_model_type_linkings', %w(instance_id custom_model_type_id), name: 'instance_custom_model_index', using: :btree
  add_index 'custom_model_type_linkings', %w(instance_id linkable_id linkable_type), name: 'instance_linkable_index', using: :btree
  ...
  add_index 'custom_model_types', %w(deleted_at instance_id), name: 'index_custom_model_types_on_deleted_at_and_instance_id', using: :btree
  add_index 'custom_model_types', %w(name deleted_at instance_id), name: 'index_custom_model_types_on_name_and_deleted_at_and_instance_id', unique: true, using: :btree
  ...
  add_index 'custom_theme_assets', %w(instance_id custom_theme_id name), name: 'cta_on_instance_id_theme_and_name_uniq', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'custom_themes', %w(instance_id themeable_id themeable_type), name: 'instance_id_and_themeable', using: :btree
  ...
  add_index 'custom_validators', %w(instance_id validatable_type validatable_id), name: 'index_custom_validators_on_i_id_and_v_type_and_v_id', using: :btree
  ...
  add_index 'customizations', %w(instance_id customizable_id customizable_type), name: 'instance_customizable_index', using: :btree
  ...
  add_index 'data_source_contents', %w(instance_id data_source_id), name: 'index_data_source_contents_on_instance_id_and_data_source_id', using: :btree
  ...
  add_index 'data_sources', %w(instance_id data_sourcable_id data_sourcable_type), name: 'index_data_sources_on_data_sourcable', using: :btree
  ...
  add_index 'data_uploads', %w(importable_id importable_type), name: 'index_data_uploads_on_importable_id_and_importable_type', using: :btree
  add_index 'data_uploads', ['instance_id'], name: 'index_data_uploads_on_instance_id', using: :btree
  add_index 'data_uploads', %w(target_id target_type), name: 'index_data_uploads_on_target_id_and_target_type', using: :btree
  ...
  add_index 'delayed_jobs', %w(platform_context_detail_id platform_context_detail_type), name: 'index_delayed_jobs_on_platform_context_detail', using: :btree
  ...
  add_index 'deposits', %w(instance_id target_id target_type), name: 'index_deposits_on_instance_id_and_target_id_and_target_type', using: :btree
  ...
  add_index 'document_requirements', %w(item_id item_type), name: 'index_document_requirements_on_item_id_and_item_type', using: :btree
  ...
  add_index 'domains', %w(target_id target_type), name: 'index_domains_on_target_id_and_target_type', using: :btree
  ...
  add_index 'form_components', %w(instance_id form_componentable_id form_type), name: 'ttfs_instance_tt_form_type', using: :btree
  ...
  add_index 'groups', %w(instance_id creator_id), name: 'index_groups_on_instance_id_and_creator_id', using: :btree
  ...
  add_index 'impressions', %w(impressionable_type impressionable_id), name: 'index_impressions_on_impressionable_type_and_impressionable_id', using: :btree
  ...
  add_index 'inappropriate_reports', %w(instance_id reportable_id reportable_type), name: 'inappropriate_reports_instance_reportable', using: :btree
  ...
  add_index 'industries', %w(instance_id name), name: 'index_industries_on_instance_id_and_name', unique: true, using: :btree
  ...
  add_index 'instance_admin_roles', %w(name instance_id), name: 'index_instance_admin_roles_on_name_and_instance_id', unique: true, using: :btree
  ...
  add_index 'instance_admins', %w(user_id instance_id), name: 'index_instance_admins_on_user_id_and_instance_id', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'instance_profile_types', %w(instance_id profile_type), name: 'index_instance_profile_types_on_instance_id_and_profile_type', unique: true, using: :btree
  add_index 'instance_profile_types', %w(instance_id searchable), name: 'index_instance_profile_types_on_instance_id_and_searchable', using: :btree
  ...
  add_index 'instance_views', %w(instance_id path format handler), name: 'instance_path_with_format_and_handler', using: :btree
  ...
  add_index 'line_items', ['partner_id'], name: 'index_line_items_on_partner_id', using: :btree
  ...
  add_index 'links', %w(instance_id linkable_id linkable_type), name: 'index_links_on_instance_id_and_linkable_id_and_linkable_type', using: :btree
  ...
  add_index 'locale_instance_views', %w(instance_id instance_view_id locale_id), name: 'index_tt_instance_views_on_instance_id_locale_view_unique', unique: true, using: :btree
  ...
  add_index 'locales', %w(instance_id code), name: 'index_locales_on_instance_id_and_code', unique: true, using: :btree
  ...
  add_index 'location_types', %w(name instance_id), name: 'index_location_types_on_name_and_instance_id', unique: true, using: :btree
  ...
  add_index 'locations', %w(external_id company_id), name: 'index_locations_on_external_id_and_company_id', unique: true, using: :btree
  ...
  add_index 'mailer_unsubscriptions', %w(user_id mailer), name: 'index_mailer_unsubscriptions_on_user_id_and_mailer', unique: true, using: :btree
  ...
  add_index 'marketplace_error_groups', %w(instance_id error_type message_digest), name: 'meg_instance_type_digest', unique: true, using: :btree
  ...
  add_index 'marketplace_errors', %w(instance_id error_type message_digest), name: 'errors_type_digest_instance', using: :btree
  ...
  add_index 'merchant_accounts', %w(instance_id merchantable_id merchantable_type), name: 'index_on_merchant_accounts_on_merchant', using: :btree
  ...
  add_index 'notification_preferences', %w(instance_id user_id), name: 'index_notification_preferences_on_instance_id_and_user_id', unique: true, using: :btree
  ...
  create_table 'old_recurring_booking_periods', force: :cascade do |t|
  ...
  add_index 'old_recurring_booking_periods', ['credit_card_id'], name: 'index_old_recurring_booking_periods_on_credit_card_id', using: :btree
  add_index 'old_recurring_booking_periods', ['instance_id'], name: 'index_old_recurring_booking_periods_on_instance_id', using: :btree
  add_index 'old_recurring_booking_periods', %w(recurring_booking_id period_start_date period_end_date), name: 'index_recurring_booking_periods_on_fk_and_dates', unique: true, using: :btree
  ...
  add_index 'page_data_source_contents', %w(instance_id page_id data_source_content_id slug), name: 'pdsc_on_foreign_keys', using: :btree
  ...
  add_index 'pages', %w(slug theme_id), name: 'index_pages_on_slug_and_theme_id', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'payment_subscriptions', %w(subscriber_id subscriber_type), name: 'subscriber_index', using: :btree
  ...
  add_index 'payouts', %w(instance_id payment_gateway_id), name: 'index_payouts_on_instance_id_and_payment_gateway_id', using: :btree
  ...
  add_index 'photo_upload_versions', %w(theme_id version_name photo_uploader), name: 'uniq_puv_theme_version_uploader', unique: true, using: :btree
  ...
  add_index 'photos', %w(instance_id owner_id owner_type), name: 'index_photos_on_owner', using: :btree
  ...
  add_index 'project_collaborators', %w(user_id project_id), name: 'index_project_collaborators_on_user_id_and_project_id', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'project_topics', %w(instance_id project_id topic_id), name: 'index_project_topics_on_instance_id_and_project_id_and_topic_id', using: :btree
  ...
  add_index 'projects', %w(instance_id creator_id), name: 'index_projects_on_instance_id_and_creator_id', using: :btree
  ...
  add_index 'projects_user_status_updates', %w(project_id user_status_update_id), name: 'project_usu_id', using: :btree
  ...
  add_index 'reverse_proxies', %w(instance_id domain_id path), name: 'index_reverse_proxies_on_instance_id_and_domain_id_and_path', unique: true, using: :btree
  ...
  add_index 'reviews', %w(rating_system_id reviewable_id reviewable_type deleted_at), name: 'index_reviews_on_rating_system_id_and_reviewable_and_deleted_at', unique: true, using: :btree
  add_index 'reviews', %w(reviewable_id reviewable_type), name: 'index_reviews_on_reviewable_id_and_reviewable_type', using: :btree
  add_index 'reviews', ['transactable_type_id'], name: 'index_reviews_on_transactable_type_id', using: :btree
  add_index 'reviews', %w(user_id reviewable_id reviewable_type subject instance_id), name: 'index_reviews_on_user_reviewable_and_type_and_subject', unique: true, where: '(deleted_at IS NULL)', using: :btree
  ...
  add_index 'saved_search_alert_logs', %w(saved_search_id created_at), name: 'index_saved_search_alert_logs_on_saved_search_id_and_created_at', using: :btree
  ...
  add_index 'saved_searches', %w(title user_id), name: 'index_saved_searches_on_title_and_user_id', unique: true, using: :btree
  ...
  add_index 'schedule_exception_rules', %w(instance_id schedule_id), name: 'index_schedule_exception_rules_on_instance_id_and_schedule_id', using: :btree
  ...
  add_index 'schedule_rules', %w(instance_id schedule_id), name: 'index_schedule_rules_on_instance_id_and_schedule_id', using: :btree
  ...
  add_index 'scheduled_uploaders_regenerations', %w(instance_id photo_uploader), name: 'uniq_sur_instance_photo_uploader', unique: true, using: :btree
  ...
  add_index 'schedules', %w(instance_id scheduable_id scheduable_type), name: 'index_schedules_scheduable', using: :btree
  ...
  add_index 'shipments', %w(instance_id reservation_id), name: 'index_shipments_on_instance_id_and_reservation_id', using: :btree
  ...
  add_index 'shipping_addresses', %w(instance_id shipment_id), name: 'index_shipping_addresses_on_instance_id_and_shipment_id', using: :btree
  add_index 'shipping_addresses', %w(instance_id user_id), name: 'index_shipping_addresses_on_instance_id_and_user_id', using: :btree
  ...
  add_index 'shipping_profiles', %w(instance_id company_id), name: 'index_shipping_profiles_on_instance_id_and_company_id', using: :btree
  ...
  add_index 'shipping_rules', %w(instance_id shipping_profile_id), name: 'index_shipping_rules_on_instance_id_and_shipping_profile_id', using: :btree
  ...
  add_index 'spree_option_values_variants', %w(variant_id option_value_id), name: 'index_option_values_variants_on_variant_id_and_option_value_id', using: :btree
  ...
  add_index 'support_ticket_message_attachments', %w(target_id target_type), name: 'stma_target_polymorphic', using: :btree
  ...
  add_index 'support_tickets', %w(target_id target_type), name: 'index_support_tickets_on_target_id_and_target_type', using: :btree
  ...
  add_index 'tags', %w(name instance_id), name: 'tags_idx', unique: true, using: :btree
  ...
  add_index 'themes', %w(owner_id owner_type), name: 'index_themes_on_owner_id_and_owner_type', using: :btree
  ...
  add_index 'topics', %w(instance_id category_id), name: 'index_topics_on_instance_id_and_category_id', using: :btree
  ...
  add_index 'topics_user_status_updates', %w(topic_id user_status_update_id), name: 'topic_usu_id', using: :btree
  add_index 'topics_user_status_updates', %w(user_status_update_id topic_id), name: 'usu_topic_id', using: :btree
  ...
  add_index 'transactable_action_types', %w(instance_id transactable_id type), name: 'transactable_action_types_main_idx', using: :btree
  ...
  add_index 'transactable_pricings', %w(instance_id action_type action_id), name: 'transactable_pricings_main_index', using: :btree
  ...
  add_index 'transactable_type_action_types', %w(instance_id transactable_type_id deleted_at), name: 'instance_tt_deleted_at_idx', using: :btree
  ...
  add_index 'transactable_type_instance_views', %w(instance_id instance_view_id transactable_type_id), name: 'index_tt_instance_views_on_instance_id_tt_view_unique', unique: true, using: :btree
  ...
  add_index 'transactable_type_pricings', %w(instance_id action_type action_id), name: 'action_type_pricings_main_index', using: :btree
  ...
  add_index 'transactables', %w(external_id location_id), name: 'index_transactables_on_external_id_and_location_id', unique: true, using: :btree
  ...
  add_index 'transactables_user_status_updates', %w(transactable_id user_status_update_id), name: 'transactable_usu_id', using: :btree
  ...
  add_index 'translations', %w(instance_id locale key), name: 'index_translations_on_instance_id_and_locale_and_key', unique: true, using: :btree
  add_index 'translations', %w(instance_id updated_at), name: 'index_translations_on_instance_id_and_updated_at', using: :btree
  ...
  add_index 'upload_obligations', %w(item_id item_type), name: 'index_upload_obligations_on_item_id_and_item_type', using: :btree
  ...
  add_index 'user_industries', %w(industry_id user_id), name: 'index_user_industries_on_industry_id_and_user_id', using: :btree
  ...
  add_index 'user_profiles', %w(instance_id user_id profile_type), name: 'index_user_profiles_on_instance_id_and_user_id_and_profile_type', unique: true, using: :btree
  ...
  add_index 'user_relationships', %w(follower_id followed_id deleted_at), name: 'index_user_relationships_on_follower_id_and_followed_id', unique: true, using: :btree
  ...
  add_index 'user_status_updates', %w(updateable_id updateable_type), name: 'usu_updateable', using: :btree
  ...
  add_index 'user_topics', %w(instance_id user_id topic_id), name: 'index_user_topics_on_instance_id_and_user_id_and_topic_id', using: :btree
  ...
  add_index 'users', %w(instance_id email external_id), name: 'index_users_on_instance_id_and_email_and_external_id', unique: true, where: '(deleted_at IS NULL)', using: :btree
  add_index 'users', %w(instance_id email), name: 'index_users_on_instance_id_and_email', unique: true, where: '((external_id IS NULL) AND (deleted_at IS NULL))', using: :btree
  add_index 'users', %w(instance_id reset_password_token), name: 'index_users_on_reset_password_token', unique: true, using: :btree
  add_index 'users', %w(instance_id slug), name: 'index_users_on_email', unique: true, using: :btree
  ...
  add_index 'users', %w(saved_searches_alerts_frequency saved_searches_count saved_searches_alert_sent_at), name: 'index_users_on_saved_search_attrs', using: :btree
  ...
  add_index 'waiver_agreement_templates', %w(target_id target_type), name: 'index_waiver_agreement_templates_on_target_id_and_target_type', using: :btree
  ...
  add_index 'waiver_agreements', %w(target_id target_type), name: 'index_waiver_agreements_on_target_id_and_target_type', using: :btree
  ...
  add_index 'webhooks', %w(instance_id webhookable_id webhookable_type), name: 'index_webhooks_on_instance_id_and_webhookable', using: :btree
  ...
  add_index 'wish_list_items', %w(instance_id wish_list_id), name: 'index_wish_list_items_on_instance_id_and_wish_list_id', using: :btree
  add_index 'wish_list_items', %w(wishlistable_id wishlistable_type), name: 'index_wish_list_items_on_wishlistable_id_and_wishlistable_type', using: :btree
  ...
  add_index 'wish_lists', %w(instance_id user_id), name: 'index_wish_lists_on_instance_id_and_user_id', using: :btree
  ...
  add_index 'workflow_alert_logs', %w(instance_id alert_type), name: 'index_workflow_alert_logs_on_instance_id_and_alert_type', using: :btree
  ...
  add_index 'workflow_alert_monthly_aggregated_logs', %w(instance_id year month), name: 'wamal_instance_id_year_month_index', unique: true, using: :btree
  ...
  add_index 'workflow_alert_weekly_aggregated_logs', %w(instance_id year week_number), name: 'wamal_instance_id_year_week_number_index', unique: true, using: :btree
  ...
  add_index 'workflow_alerts', %w(instance_id workflow_step_id), name: 'index_workflow_alerts_on_instance_id_and_workflow_step_id', using: :btree
  add_index 'workflow_alerts', %w(template_path workflow_step_id recipient_type alert_type deleted_at), name: 'index_workflows_alerts_on_templ_step_recipient_alert_and_del', unique: true, using: :btree
  ...
  add_index 'workflow_steps', %w(associated_class instance_id deleted_at), name: 'index_workflow_steps_on_assoc_class_and_instance_and_deleted', unique: true, using: :btree
