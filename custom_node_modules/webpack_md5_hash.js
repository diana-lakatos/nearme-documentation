...
WebpackMd5Hash.prototype.apply = function(compiler) {
    compiler.plugin('compilation', function(compilation) {
        var
            context = compilation.options.context.replace(/\//g,'\/'),
            node_modules = path.join(path.dirname(compilation.options.context), 'shared', 'node_modules').replace(/\//g,'\/');
        ...
        compilation.plugin('chunk-hash', function(chunk, chunkHash) {
            ...
            source = source.replace(new RegExp(node_modules, 'g'), '');
