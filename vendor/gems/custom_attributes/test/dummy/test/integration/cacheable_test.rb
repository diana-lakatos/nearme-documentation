...
class CacheableTest < ActionDispatch::IntegrationTest
  ...
  should 'populate cache variable and timestamp' do
    Timecop.freeze(Time.zone.now) do
      ...
      assert_equal [@custom_attribute.name, @custom_attribute.attribute_type, @custom_attribute.default_value, @custom_attribute.public, nil, []], CustomAttributes::CustomAttribute::CacheDataHolder.custom_attributes_as_array['SampleModelType'][@sample_model_type.id].first
