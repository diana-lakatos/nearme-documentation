...
class Listings::ReservationsControllerTest < ActionController::TestCase
  ...
  context 'export' do
    ...
    setup do
      ...
      @reservation.add_period(Time.zone.local(2013, 7, 1, 10, 5, 0).utc)
      @reservation.add_period(Time.zone.local(2013, 7, 2, 10, 5, 0).utc)
      @reservation.add_period(Time.zone.local(2013, 7, 3, 10, 5, 0).utc)
      @reservation.save!
    ...
    should 'be exportable to .ics format' do
      ...
      expected_result = ["BEGIN:VCALENDAR", "VERSION:2.0", "CALSCALE:GREGORIAN", "METHOD:PUBLISH", "PRODID:iCalendar-Ruby",
        "BEGIN:VEVENT", "CREATED:100500", "DESCRIPTION:42 Wallaby Way - ICS Listing", "DTEND:20130701T170000",
        "DTSTAMP:20130628T120500", "DTSTART:20130701T090000", "CLASS:PUBLIC", "LAST-MODIFIED:100500",
        "LOCATION:42 Wallaby Way", "SEQUENCE:0", "SUMMARY:ICS Listing", "UID:http://example.com/listings/1/reservations/1/export.ics",
        "URL:http://example.com/listings/1/reservations/1/export.ics", "END:VEVENT", "BEGIN:VEVENT", "CREATED:100500",
        "DESCRIPTION:42 Wallaby Way - ICS Listing", "DTEND:20130702T170000", "DTSTAMP:20130628T120500", "DTSTART:20130702T090000",
        "CLASS:PUBLIC", "LAST-MODIFIED:100500", "LOCATION:42 Wallaby Way", "SEQUENCE:0", "SUMMARY:ICS Listing",
        ...
        "DTSTAMP:20130628T120500", "DTSTART:20130703T090000", "CLASS:PUBLIC", "LAST-MODIFIED:100500", "LOCATION:42 Wallaby Way",
        "SEQUENCE:0", "SUMMARY:ICS Listing", "UID:http://example.com/listings/1/reservations/1/export.ics", 
        "URL:http://example.com/listings/1/reservations/1/export.ics",
