...
class DataUploadTest < ActionDispatch::PerformanceTest
 ...
 #  XML_PATH_TMP = Rails.root.join('test', 'assets', 'data_importer', 'xml', 'xml_template_file_tmp.xml')
 #  XML_PATH = Rails.root.join('test', 'assets', 'data_importer', 'xml', 'xml_template_file.xml')
