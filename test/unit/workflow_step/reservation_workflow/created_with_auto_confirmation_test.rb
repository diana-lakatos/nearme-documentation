...
class WorkflowStep::ReservationWorkflow::CreatedWithAutoConfirmationTest < ActiveSupport::TestCase
  context 'attachments' do
    ...
    should 'return attachment if alert has it configured' do
      @manually_confirmed = WorkflowStep::ReservationWorkflow::CreatedWithAutoConfirmation.new(@reservation.id)
