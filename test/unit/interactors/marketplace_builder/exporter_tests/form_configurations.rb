    ...
    class ShouldExportFormConfiguration < Basic
      ...
      def seed!
        FormConfiguration.create!(instance_id: @instance.id,
                                  name: 'refer_a_friend',
                                  configuration: {"properties"=>{"enquirer_name"=>{"validation"=>{"presence"=>true}}}},
      ...
      def execute!
        ...
        assert_equal liquid_content.configuration, {"properties"=>{"enquirer_name"=>{"validation"=>{"presence"=>true}}}}
