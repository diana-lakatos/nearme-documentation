  ...
  context 'methods' do
    ...
    context 'finished data upload' do
      ...
      should 'finished data_upload without validation errors' do
        ...
        assert_contains "href=\"http://custom.domain.com/dashboard/company/transactable_types/#{@data_upload.transactable_type_id}/transactables/new", mail.html_part.body
        ...
        assert_contains "http://custom.domain.com/dashboard/company/transactable_types/#{@data_upload.transactable_type_id}/transactables/new", mail.text_part.body
      end
