...
Feature: Emails should be sent out informing parties about bookings
  ...
  # Emails
  #
  # 1. When user creates a booking, one of (depending on confirmation setting):
  #   a) email to owner asking to confirm/decline
  #   b) email to owner telling them that a booking has been made
  ...
  # 6. When user creates a booking, one of (depending on confirmation)
  #   a) email to user telling them to wait for confirmation
  #   b) email to user telling them their booking is confirmed
