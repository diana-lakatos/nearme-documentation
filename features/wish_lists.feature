...
Feature: User can add locations to wish list
  ...
  Scenario: User can't add location to wish list if not logged in
    Given I go to the location's page
    When I click to Add to Favorites
    Then I should see "Log in to" platform name

  Scenario: User can add location to wish list after logging in
    Given I go to the location's page
    When I click to Add to Favorites
    Then I should see "Log in to" platform name
  ...
  Scenario: User can add/remove location to/from wish list
  ...
  Scenario: User can visit and manage wish list under dashboard section
    ...
    Then I should see "My loved location"
