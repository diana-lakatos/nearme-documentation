Feature: As a user of the site
  In order for them to manage their bookings / workspaces
  As a user
  ...
  Scenario: A user can add a workspace from this page
    Given I am on the dashboard
    When I follow "Create Workspace"
      Then I should be on the new workplace page

  Scenario: A user can see their workspaces
    Given a workplace exists with creator: the user, name: "Rad Annex"
  ...
  Scenario: A user can get to the edit workspace page
    Given a workplace exists with creator: the user, name: "Rad Annex"
     When I am on the dashboard
      And I follow "Edit Workspace"
