Feature: A user can add a listing to a location for a company
  ...
  Scenario: A registered user can create a listing to a location for a company
  ...
  Scenario: A registered user can't create a listing with a description that is longer than 250 characters
    Given I am logged in as a user
     And  I go to the home page
     And  I follow "List Your Space"
     And I should be at the "Company" step
     ...
     When I fill in "Name" with "Conference Room"
     And I fill in "Quantity available" with "2"
     And I fill in "Description" with "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus sagittis sollicitudin lacinia. Donec nulla metus, auctor eget malesuada bibendum, tempor a arcu. Fusce in libero vitae ligula accumsan imperdiet. Fusce quis erat augue. Etiam volutpat."
     And I fill in "Price per day" with "200"
     And I choose "Yes"
     And I press "Save and Continue"
     Then I should not see "Great, your space has been set up!"
