Feature: As a user of the site
  ...
  Scenario: User rejects reservation
    Given a future_unconfirmed_reservation exists with transactable: the transactable
  ...
  Scenario: A user will see information about no reservation
    Given a future_confirmed_reservation exists with transactable: the transactable
    Given I am on the guests page
    Then I should see "You don't have any orders yet"

  Scenario: A user will see information about no reservation for past reservation
    Given a past_reservation exists with transactable: the transactable
    Given I am on the guests page
    Then I should see "You don't have any orders yet"
