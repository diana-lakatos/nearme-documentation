class Dashboard::Company::TransactableTypes::DataUploadsController < Dashboard::Company::BaseController
  ...
  def schedule_import
    ...
    redirect_to dashboard_company_transactable_type_data_uploads_path(@transactable_type)
  end
