class InstanceAdmin::Manage::ServiceTypes::CategoriesController < InstanceAdmin::BaseController
  ...
  def destroy
    ...
    redirect_to instance_admin_manage_service_type_categories_path(@categorable)
  end
  ...
  def redirect_path
    edit_instance_admin_manage_service_type_category_path(@categorable, @category)
  end
