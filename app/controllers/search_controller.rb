...
class SearchController < ApplicationController
  ...
  def filters
    search_filters = {}
    search_filters[:location_type_filter] = params[:listing_types_ids].map { |lt| ListingType.find(lt).name } if params[:listing_types_ids]
    search_filters[:listing_type_filter] = params[:location_types_ids].map { |lt| LocationType.find(lt).name } if params[:location_types_ids]
