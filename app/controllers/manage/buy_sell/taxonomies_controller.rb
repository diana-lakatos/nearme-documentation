class Manage::BuySell::TaxonomiesController < Manage::BuySell::BaseController
  ...
  def create
    ...
    if @taxonomy.save
      ...
      redirect_to edit_manage_buy_sell_taxonomy_path(@taxonomy)
    else
      render :new
    end
  end
  ...
  def update
    ...
    if @taxonomy.update_attributes(taxonomy_params)
      ...
      redirect_to manage_buy_sell_taxonomies_path
    else
      render 'edit'
    end
  end
