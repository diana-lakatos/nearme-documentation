    ...
    module Validations
      class ValidatePlaceOrderRequest
        ...
        def initialize(delivery)
          # clone structure but id - thus persisted -> false
          # this is needed for storing order external states
        ...
        def duplicate(delivery)
          delivery.dup.tap do |d|
            d.receiver_address = delivery.receiver_address
            d.sender_address = delivery.sender_address
          end
        end
