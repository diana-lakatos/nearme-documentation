...
module Payable
  ...
  included do
    ...
    def authorize_payment
      ...
      elsif payment_subscription && payment_subscription.valid? && payment.blank? && payment_subscription.credit_card.store!
    ...
    def total_payable_to_host_cents
      total_amount_cents - service_fee_amount_host_cents - service_fee_amount_guest_cents
    end
  end
end
