...
class FormConfiguration
  class FormObjectFactory
    ALLOWED_OBJECT_CLASSES = %w(User UserProfile Transactable Customization ShoppingCart CheckoutShoppingCart Order UserMessage RecurringBookingPeriod).freeze
