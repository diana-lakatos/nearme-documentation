class OldRecurringBooking < ActiveRecord::Base
  self.table_name = "recurring_bookings"
  ...
  has_many :old_recurring_booking_periods, dependent: :destroy, foreign_key: "recurring_booking_id"
