  ...
  class << self
    def decorate(configuration)
      Class.new(self) do
        ...
        inject_dynamic_fields(configuration, whitelisted: [:email, :name, :phone, :country_name, :mobile_number, :company_name, :time_zone, :sms_notifications_enabled, :first_name, :middle_name, :last_name, :accept_emails, :saved_searches_alerts_frequency, :language, :featured, :click_to_call, :public_profile])
      end
    end
  end
