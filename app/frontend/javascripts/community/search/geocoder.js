/* global google */
var SearchGeocoder, slice = [].slice;

SearchGeocoder = function() {
  ...
  Result = function() {
    ...
    Result.prototype.boundingBox = function() {
      ...
      throw new Error('Missing viewport parameter');
    };
   ...
   */
  SearchGeocoder.wrapResult = function(resultObject) {
   ...
   */
  SearchGeocoder.prototype.geocodeAddress = function(address) {
   ...
   */
  SearchGeocoder.prototype.reverseGeocodeLatLng = function(lat_or_latlng, lng) {
    var latlng;
    if (lng == null) {
      lng = void 0;
    }
  ...
  SearchGeocoder.prototype.geocodeWithOptions = function(options) {
    var deferred;
  ...
  return SearchGeocoder;
}();

module.exports = SearchGeocoder;
