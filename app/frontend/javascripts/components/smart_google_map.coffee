module.exports = class SmartGoogleMap
  ...
  @setStyles: (map) ->
    options = {
      ...
      styles:
        [{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#457cbc"}]},
        {"featureType":"water","elementType":"labels.text.stroke","stylers":[{"weight":0.1},{"color":"#d0bfe0"},{"visibility":"off"}]},
        {"featureType":"water","elementType":"labels.text.fill","stylers":[{"visibility":"on"},{"lightness":5},{"color":"#e6e4e7"}]},
        ...
        {"elementType":"labels.text.stroke","stylers":[{"visibility":"off"}]},{"featureType":"poi.school","elementType":"labels","stylers":[{"weight":0.1},
        {"visibility":"simplified"}]},{"featureType":"poi.medical","elementType":"labels","stylers":[{"visibility":"simplified"}]},
