...
module.exports = class PhoneNumberFieldsForm

  constructor: (container = 'div[data-phone-fields-container]', {@countrySelector, @codeSelector, @mobileSelector, @phoneSelector, @sameAsSelector} = {}) ->
    @container = $(container)
    _.defaults @,
