...
ChartWrapperLine = function(superClass) {
  extend(ChartWrapperLine, superClass);

  function ChartWrapperLine(canvas, data, labels, titles, customYScale) {
    if (titles == null) {
      titles = [];
    }
    ...
    ChartWrapperLine.__super__.constructor.call(this, canvas, data, labels, titles);
  }

  ChartWrapperLine.prototype.draw = function() {
  ...
  return ChartWrapperLine;
}(ChartWrapper);

module.exports = ChartWrapperLine;
