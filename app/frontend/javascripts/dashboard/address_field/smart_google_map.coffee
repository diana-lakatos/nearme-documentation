module.exports = class SmartGoogleMap
  ...
  @setStyles: (map) ->
    options = {
      ...
      styles: [{"featureType":"water","elementType":"geometry.fill","stylers":[{"color":"#457cbc"}]},
        ...
        {"featureType":"poi.medical","elementType":"labels","stylers":[{"visibility":"simplified"}]},{"featureType":"poi","elementType":"geometry.fill"},
