...
IntroVideo = function() {
  ...
  IntroVideo.prototype.initStructure = function() {
    this.container.html(
      '<div class="intro-video-overlay"></div><div class="intro-video-wrapper"><div id="intro-player"></div></div><button type="button" class="intro-video-close button-a">Close Video</button>'
    );
