class SingleFileView extends React.Component {
  render() {
return <div className="file-manager-info-pane single-file">
  <div className="file-name" data-file-name>
    ...
    <form className="file-name-form" action="#" data-file-name-form>
      <input type="text" value='file_1.pdf' data-file-name-input /><button type='submit'>Change name</button></form></div>
  ...
  <dl className="properties">
    ...
    <dd>
      ...
      <button className="clipboard-copy" type="button" title='Copy to clipboard'>Copy to clipboard</button>
    </dd>
    <dt>Liquid tag</dt>
    <dd>
      <input type="url" readOnly value='{{ "file/somefolder/file_1.pdf" | asset_url }} '/>
      <button className="clipboard-copy" type="button" title='Copy to clipboard'>Copy to clipboard</button>
    </dd>
    <dt>Access</dt>
    <dd>
      <form className="access-level" action="#">
        ...
        <button type="submit">Change access level</button></form>
    </dd>
    <dt>Preview</dt>
