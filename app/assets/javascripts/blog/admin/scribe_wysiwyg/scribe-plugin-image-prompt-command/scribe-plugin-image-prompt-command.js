define('scribe-plugin-image-prompt-command', [], function () {
    ...
    return function () {
        return function (scribe) {
            var linkPromptCommand = new scribe.api.Command('insertImage');

            linkPromptCommand.nodeName = 'IMG';
            ...
            linkPromptCommand.execute = function () {
                ...
                var initialLink = anchorNode ? anchorNode.src : 'http://';
                var link = window.prompt('Enter a image link.', initialLink);
            ...
            scribe.commands.imagePrompt = linkPromptCommand;
        };
    };
