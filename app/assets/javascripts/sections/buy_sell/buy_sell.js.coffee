      ...
      $.ajax
        ...
        success: (taxonomy) ->
          ...
          conf =
            ...
            contextmenu:
              items: (obj) ->
                TaxonomiesTree.taxonTreeMenu(obj, this)
            plugins: ["themes", "json_data", "dnd", "crrm", "contextmenu"]

          $("#taxonomy_tree").jstree(conf)
            .bind("move_node.jstree", TaxonomiesTree.handleMove)
            .bind("remove.jstree", TaxonomiesTree.handleDelete)
            .bind("create.jstree", TaxonomiesTree.handleCreate)
            .bind("rename.jstree", TaxonomiesTree.handleRename)
            .bind "loaded.jstree", ->
