class RecurringBookingPeriodDrop < BaseDrop
  ...
  # @return [RecurringBookingPeriod]
  attr_reader :source

  # @!method id
  #   @return [Integer] numeric identifier for the recurring booking period
  # @!method line_items
  #   @return [Array<LineItem>] line items associated with this recurring booking period
  # @!method created_at
  #   @return [ActiveSupport::TimeWithZone] time when the recurring booking period was created
  # @!method payment
  #   @return [Payment] payment object associated with this recurring booking period
  ...
  # @!method order
  #   Order object to which this period belongs to
  #   @return (see RecurringBookingPeriod#order)
  # @!method persisted?
  ...
  # @return [RecurringBooking] recurring booking (order) associated with this period
