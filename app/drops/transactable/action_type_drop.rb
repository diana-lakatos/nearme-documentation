...
class Transactable::ActionTypeDrop < BaseDrop
  ...
  # @!method pricings
  #   array of pricings
  #   @return (see Transactable::ActionType#pricings)
  ...
  # @return [Transactable::Pricing] returns the first pricing
  def first_pricing
    pricings.first
  end

  # @return [Array<Transactable::Pricing>] sorted (by number of units) pricing objects for this action type
  def sorted_pricings
