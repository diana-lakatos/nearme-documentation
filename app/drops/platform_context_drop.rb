...
class PlatformContextDrop < BaseDrop
  ...
  # @!method use_cart?
  #   @return [Boolean] returns TRUE if marketplace is using cart for checkout
  ...
  delegate :name, :bookable_noun, :pages, :blog_url, :facebook_url, :twitter_url, :gplus_url,
           ...
           :transactable_types_ordered, :transactable_types_as_hash, :google_analytics_tracking_code,
           :instance_profile_types_as_hash, :use_cart?, to: :platform_context_decorator
  ...
  def logo_url
    ...
    platform_image_url.present? ? platform_image_url : 'https://s3-us-west-1.amazonaws.com/near-me-assets/logo-black.svg'
  end
